...
class StreamingTranscriptionService extends EventEmitter {
    ...
    async startSession(metadata = {}) {
        ...
        const baseStreamingConfig = this.config.streaming || {};
        const overrideStreamingConfig = metadata.streamingConfig || null;
        const mergedStreamingConfig = overrideStreamingConfig
            ? {
                ...baseStreamingConfig,
                ...overrideStreamingConfig,
                vad: {
                    ...(baseStreamingConfig.vad || {}),
                    ...(overrideStreamingConfig.vad || {})
                }
            }
            : baseStreamingConfig;
        ...
        const session = new LiveStreamingSession({
            ...
            client,
            streamingConfig: mergedStreamingConfig,
